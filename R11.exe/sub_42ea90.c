...
if (eax_2 == 0)
    sub_43d220(esi + 0x15788, 0x4be808, 2, 0, 0xffffffff, 0x1000)
    sub_441740(data_4bf344 + 0x1f0f0, 0x280, 0xa)
    sub_441760(data_4bf344 + 0x1f0f0, 0, 0)
    sub_43d220(data_4bf344 + 0x19c3c, 0x4be818, 3, 0, 0xffffffff, 0xe14)
    esi = data_4bf344
    *(arg1 + 0x10) = 1
label_42ecd1:
    ...
    if (eax_2 == 2)
        ...
        if (cond:1_1 || (eax_8 & 0x2100) != 0)
            ...
            sub_4095a0(0)
            sub_4012a0()
            void* var_14 = data_4bf344 + 0x11f210
            sub_401350()
            sub_42ab90()
            void* edx_3 = data_4bf344
            *(eax_1 * 0x18 + 0x4bf014) = 0
            *(edx_3 + 0xb224) = 0
            *(arg1 + 0x10) = 1
            sub_42b560(0x1c)
