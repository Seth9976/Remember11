...
int16_t ecx_10 = *arg2 + data_c7bbd0.w
int32_t edx_35
edx_35.w = ecx_10
esi[0x24] = edx_35.w
esi[0x2c] = ecx_10
...
esi[0x25] = (ecx_11 u>> 0x10).w | (eax_45 << 0x10).w
int32_t edx_39 = data_c7bbd8 & 0xffffff
*(esi + 0x48) = *(esi + 0x48)
int32_t edx_40 = edx_39 | (eax_45 & 0xff000000)
int32_t eax_48 = *(esi + 0x4c) ^ edx_40
*(esi + 0x58) = ecx_11
*(esi + 0x5c) = edx_40
*(esi + 0x4c) ^= eax_48 & 0xffffff
ecx_11.b = data_c7bbdc
edx_40.b = ecx_11.b
*(esi + 0x5f) = ecx_11.b
*(esi + 0x4f) = edx_40.b
esi[0x2c] += *(arg1 + 0x24) << 4
esi[0x2d] += *(arg1 + 0x28) << 4
