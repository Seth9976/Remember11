...
int32_t eax_1 = sub_448950(esi, 0x2801, 1)
int32_t eax_3
int32_t edx
...
int32_t ebp_8 = *(esi + 0x4c)
*(esi + 0x40) = *(esi + 0x40)
int32_t ebx_8 = *(esi + 0x48)
*(esi + 0x4c) = (edx_4 & 0xffffff) | (ebp_8 & 0xff000000)
int32_t edx_8 = *(esi + 0x44) ^ *(esi + 0x4c)
*(esi + 0x48) = ebx_8
*(esi + 0x44) ^= edx_8 & 0xffffff
int32_t eax_10
eax_10.b = data_c7bbdc
*(esi + 0x4f) = eax_10.b
int16_t ecx_1
ecx_1.b = eax_10.b
*(esi + 0x47) = ecx_1.b
