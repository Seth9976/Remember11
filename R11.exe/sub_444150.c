...
int32_t eax_35 = __allmul(eax_33, edx_14, 0x10000, 0) + eax_30
int32_t edx_13
*(esi + 0x54) = edx_13
*(esi + 0x50) = ((eax_35 ^ eax_30) & 0x3fff0000) ^ eax_30
...
int32_t edi_16 = data_c7bbd8 & 0xffffff
int32_t edx_37 = *(esi + 0x4c)
*(esi + 0x48) = *(esi + 0x48)
int32_t edi_17 = edi_16 | (eax_45 & 0xff000000)
*(esi + 0x58) = edx_36
*(esi + 0x5c) = edi_17
*(esi + 0x4c) ^= (edx_37 ^ edi_17) & 0xffffff
int32_t eax_46
