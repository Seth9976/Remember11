...
void* eax_3 = *(arg1 + 4)
void* eax_4 = sub_453840(eax_3, arg4, eax_3, arg5, 0)
void* eax_5 = *(arg1 + 4)
*(arg1 + 8) += 1
    ...
    do
        ...
        if (ecx_3 != *edx_2)
            ...
            if (*(edx_3 + 0x30) != 0)
                if (esi_1 == *(ecx_3 + 8))
                    esi_1 = ecx_3
                    sub_451a80(arg1, esi_1)
                
                *(*(esi_1 + 4) + 0x30) = 1
                *(*(*(esi_1 + 4) + 4) + 0x30) = 0
                sub_450d00(arg1, *(*(esi_1 + 4) + 4))
            else
                *(ecx_3 + 0x30) = 1
                *(edx_3 + 0x30) = 1
                *(*(*eax_9 + 4) + 0x30) = 0
