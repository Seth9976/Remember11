...
int32_t eax_1 = sub_448950(esi, 0x2806, 1)
int32_t eax_3
int32_t edx
...
int16_t edx_4 = *arg1 + data_c7bbd0.w
esi[0x20] = edx_4
int32_t eax_11 = *(esi + 0x4c)
esi[0x24] = edx_4
esi[0x25] = arg1[2] + data_c7bbd4.w
int32_t edx_6 = *(esi + 0x48)
esi[0x21] = (edx_6 u>> 0x10).w | (eax_11 << 0x10).w
int32_t ebx_10 = data_c7bbd8
*(esi + 0x40) = *(esi + 0x40)
int32_t ebx_12 = (ebx_10 & 0xffffff) | (eax_11 & 0xff000000)
*(esi + 0x44) ^= (*(esi + 0x44) ^ ebx_12) & 0xffffff
*(esi + 0x48) = edx_6
*(esi + 0x4c) = ebx_12
edx_6.b = data_c7bbdc
int32_t eax_15
