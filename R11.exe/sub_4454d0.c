...
int16_t eax_39 = *arg1 + data_c7bbd0.w
esi[0x2c] = eax_39
int32_t eax_40 = *(esi + 0x5c)
esi[0x24] = eax_39
int32_t edx_35
edx_35.w = arg1[2]
...
esi[0x25] = (ecx_11 u>> 0x10).w | (eax_40 << 0x10).w
int32_t edx_40 = (data_c7bbd8 & 0xffffff) | (eax_40 & 0xff000000)
int32_t eax_42 = *(esi + 0x4c)
*(esi + 0x58) = ecx_11
*(esi + 0x5c) = edx_40
*(esi + 0x48) = *(esi + 0x48)
*(esi + 0x4c) ^= (eax_42 ^ edx_40) & 0xffffff
