...
if (*(eax_4 + 0xa1) == 0)
    ...
    *arg3 = *arg3
    ...
    edx_2.b = arg3[0x28].b
    int32_t eax_13
    eax_13.b = arg3[0x28].b
    arg3[0x28].b = edx_2.b
    arg3[0x28].b = eax_13.b
else
    edi = arg3[2]
label_454ab3:
    esi = arg3[1]
        ...
        while (edi[0x28].b == 1)
            ...
            if (edi != eax_15)
                ...
                if (*(eax_15 + 0xa1) == 0)
                    ...
                    if (*(edx_5 + 0xa0) != 1 || *(*eax_15 + 0xa0) != 1)
                        if (*(*eax_15 + 0xa0) == 1)
                            *(edx_5 + 0xa0) = 1
                            eax_15[0x28].b = 0
                            sub_451ad0(arg1, eax_15)
                            eax_15 = *esi
                        
                        void* ecx_14
                        ecx_14.b = esi[0x28].b
                        eax_15[0x28].b = ecx_14.b
                        esi[0x28].b = 1
                        *(*eax_15 + 0xa0) = 1
                        sub_450dc0(arg1, esi)
                        break
                ...
                if (*(eax_15 + 0xa1) == 0)
                    ...
                    if (*(edx_3 + 0xa0) != 1 || *(eax_15[2] + 0xa0) != 1)
                        if (*(eax_15[2] + 0xa0) == 1)
                            *(edx_3 + 0xa0) = 1
                            eax_15[0x28].b = 0
                            sub_450dc0(arg1, eax_15)
                            eax_15 = esi[2]
                        
                        void* ecx_9
                        ecx_9.b = esi[0x28].b
                        eax_15[0x28].b = ecx_9.b
                        esi[0x28].b = 1
                        *(eax_15[2] + 0xa0) = 1
                        sub_451ad0(arg1, esi)
                        break
