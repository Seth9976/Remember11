        ...
        *__errno() = 9
        ...
        if ((*((&data_2b6a8a0)[arg1 s>> 5] + esi_3 + 4) & 1) == 0)
            ...
            *___doserrno() = 0
            ...
            result_1 = sub_496cf9(arg1, arg2, arg3)
        
        int32_t var_8_2 = 0xfffffffe
        sub_496e3d(&__saved_ebp)
        result = result_1
else
    *___doserrno() = 0
    *__errno() = 9
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_2 = &data_496e3c
return result
