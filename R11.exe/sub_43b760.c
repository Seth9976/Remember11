...
eax_25.w = arg2[2]
eax_25.w <<= 4
eax_25.w += data_c7bbd4.w
esi[0x2d] = eax_25.w
int32_t ecx_18 = *(esi + 0x58)
int32_t eax_26 = *(esi + 0x5c)
esi[0x25] = (ecx_18 u>> 0x10).w | (eax_26 << 0x10).w
int32_t edx_32 = data_c7bbd8
*(esi + 0x48) = *(esi + 0x48)
int32_t edx_34 = (edx_32 & 0xffffff) | (eax_26 & 0xff000000)
*(esi + 0x4c) ^= (edx_34 ^ *(esi + 0x4c)) & 0xffffff
*(esi + 0x5c) = edx_34
*(esi + 0x58) = ecx_18
ecx_18.b = data_c7bbdc
edx_34.b = ecx_18.b
*(esi + 0x4f) = edx_34.b
*(esi + 0x5f) = ecx_18.b
int32_t eax_34
int32_t edx_35
edx_35:eax_34 = sx.q((*(edi_3 + 0x14) << 4) * *(arg2 + 8))
esi[0x2c] += ((eax_34 + (edx_35 & 0xfff)) s>> 0xc).w
int32_t eax_40
int32_t edx_37
edx_37:eax_40 = sx.q((*(edi_3 + 0x18) << 4) * *(arg2 + 0xc))
esi[0x2d] += ((eax_40 + (edx_37 & 0xfff)) s>> 0xc).w
