...
int32_t eax_3
int32_t edx
edx:eax_3 = sx.q(*(arg1 + 0x10) & 0x3fff)
*(esi + 0x8c) |= edx
*(esi + 0x44) = *(esi + 0x44)
...
int32_t eax_8
int32_t edx_11
edx_11:eax_8 = sx.q(*(arg1 + 0x14) & 0x3fff)
...
int32_t eax_20
int32_t edx_20
edx_20:eax_20 = sx.q((*(arg1 + 0x18) + *(arg1 + 0x10)) & 0x3fff)
...
int32_t eax_26
int32_t edx_26
edx_26:eax_26 = sx.q((*(arg1 + 0x1c) + *(arg1 + 0x14)) & 0x3fff)
