...
if (ebx_2 != 0xffffc001)
    ...
    *(edi_4 + 4) = esi_1[1]
    ...
    int32_t eax_17 = data_4ccaa4
    
    if (ebx_2 s< eax_17 - data_4ccaa8)
        var_24 = 0
        ...
        *edi_9 = 0
        ...
        int32_t ecx_36 = data_4ccaac
        
        if (ebx_2 s< data_4ccaa0)
            int32_t eax_42 = data_4ccab4
            var_24 &= 0x7fffffff
            ebx_3 = ebx_2 + eax_42
            int32_t eax_44
            int32_t edx_45
...
int32_t ecx_57 = data_4ccab0
int32_t ebx_13 =
    ebx_3 << (0x1f - (data_4ccaac).b) | (sbb.d(ecx_54, ecx_54, ecx_1 != 0) & 0x80000000) | var_24
